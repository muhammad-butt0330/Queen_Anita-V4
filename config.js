...
global.owner = process.env.OWNER_NUMBER.split('923309899931'); 
global.anitav4 = process.env.BOT_NAME || "BUTT_BOT-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "MUHAMMAD BUTT";
global.packname = process.env.PACK_NAME || "BUTT BOT_-𝐕𝟒";
global.author = process.env.AUTHOR || "𝐃𝐀𝐕𝐈𝐃 𝐂𝐘𝐑𝐈𝐋";
global.channelname = process.env.CHANNEL_NAME || "MUHAMMAD BUTT";
